...
public :
	Terminal(std::shared_ptr<Node> parentNode, int index, const std::string &name, TerminalType type);	
...
public:
	InputTerminal(std::shared_ptr<Node> parentNode, int index, const std::string &name);	
